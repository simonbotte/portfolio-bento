...
<template>
    <div ref="projectBento" class=" col-span-2 row-span-2 h-bento-mobile-2 bg-sand-800 rounded-2xl p-4 flex flex-col justify-between tablet:h-bento-tablet tablet:row-span-1 laptop:p-6 laptop:h-bento-laptop">
