...
const project = ref(projectsData.value?.project);
const nextProject = ref(projectsData.value?.nextProject);
const previousProject = ref(projectsData.value?.previousProject);
